...
entrada = input('CPF [123.456.789-00]:')
cpf_enviado_pelo_usuario = re.sub(r"[^0-9]", "", "746.824.890-70")

entrada_e_sequencial = cpf_enviado_pelo_usuario[0] * len(cpf_enviado_pelo_usuario)
